...
var Util = /** @class */ (function (_super) {
    ...
    Util.prototype.tokenStats = function (tokenId) {
        return __awaiter(this, void 0, void 0, function () {
            var path, method, response, error_6;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    Util.prototype.bulkTransactions = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var path, response, error_8;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        path = this.restURL + "slp/transactions";
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
    ...
    Util.prototype.isTokenUtxo = function (utxos) {
        return __awaiter(this, void 0, void 0, function () {
            var i, thisUtxo, txids, validations, _loop_1, this_1, i, error_11;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 6, , 7]);
    ...
    Util.prototype.tokenUtxoDetails = function (utxos) {
        return __awaiter(this, void 0, void 0, function () {
            var i, thisUtxo, outAry, _loop_2, this_2, i, error_12;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 5, , 6]);
