...
var Address = /** @class */ (function (_super) {
    ...
    Address.prototype.toCashAddress = function (address, prefix, regtest) {
        ...
        if (regtest === void 0) { regtest = false; }
        this._ensureValidAddress(address);
        var cashAddress = utils.toLegacyAddress(address);
        if (prefix)
            return cashAddress;
    ...
    Address.prototype.toLegacyAddress = function (address) {
        this._ensureValidAddress(address);
        var cashAddr = utils.toLegacyAddress(address);
    ...
    Address.prototype.details = function (address) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                if (network === "mainnet")
                    tmpBITBOX = new bitbox_sdk_1.BITBOX({ restURL: "https://rest.zslp.org/v2/" });
                else
                    tmpBITBOX = new bitbox_sdk_1.BITBOX({ restURL: "https://trest.zslp.org/v2/" });
                if (typeof address === "string") {
                    cashAddr = utils.toLegacyAddress(address);
                    return [2 /*return*/, tmpBITBOX.Address.details(cashAddr)];
                }
                address = address.map(function (address) { return utils.toLegacyAddress(address); });
