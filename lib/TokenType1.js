...
var TokenType1 = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        tokenInfo = _a.sent();
                        mintQty = mintConfig.burnBaton === true
                            ? new BigNumber(0)
                            : new BigNumber(mintConfig.additionalTokenQty).times(Math.pow(10, tokenInfo.decimals));
                        nonSlpUtxos = balances.reduce(function (previousNonSlpUtxos, currentBalance, index) { return __spreadArrays(previousNonSlpUtxos, currentBalance.result.nonSlpUtxos.map(function (utxo) { return (__assign(__assign({}, utxo), { wif: fundingWifs[index] })); })); }, []);
                        ...
                        return [4 /*yield*/, bitboxNetwork.simpleTokenMint(mintConfig.tokenId, mintQty, inputUtxos, mintConfig.tokenReceiverAddress, mintConfig.burnBaton === true ? null : batonReceiverAddress, mintConfig.bchChangeReceiverAddress, mintConfig.burnBaton === undefined ? false : mintConfig.burnBaton)];
                    case 3:
                        mintTxid = _a.sent();
    ...
    TokenType1.prototype.returnBITBOXInstance = function (network) {
        ...
        var restURL;
        if (network === "mainnet")
            restURL = "https://rest.zslp.org/v2/";
        else
